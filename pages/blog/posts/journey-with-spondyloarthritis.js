...
export default () => {
  ...
  return (
    <>
      <Head>
        <title>The Journey with Spondyloarthritis | Lushfulness</title>
      </Head>

      {/* KEY WORDS: spondyloarthritis symptoms, spondyloarthritis, ankylosing spondylitis, non-radiographic axial spondyloarthritis */}
      <NextSeo
        title='The Journey with Spondyloarthritis'
        description='The path to a diagnosis of ankylosing spondylitis can be a lonely and difficult journey. Spondyloarthritis may obscure the path to your life goals. Lushfulness is a community cultivating well-being and reminding us that no matter your current circumstance, you have what you need to be who you desire to be, doing what you desire to do.'
        canonical='https://lushfulness.com/blog/posts/journey-with-spondyloarthritis'
        openGraph={{
          url: 'https://lushfulness.com/blog/posts/journey-with-spondyloarthritis',
          title: 'journey-with-spondyloarthritis | Lushfulness',
          description: 'The path to a diagnosis of ankylosing spondylitis can be a lonely and difficult journey. Spondyloarthritis may obscure the path to your life goals. Lushfulness is a community cultivating well-being and reminding us that no matter your current circumstance, you have what you need to be who you desire to be, doing what you desire to do.',
          images: [
            {
              url: 'https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/old-man-painting-770.jpg',
              width: 770,
              height: 514,
              alt: 'old-man-painting',
            },
            {
              url: 'https://res.cloudinary.com/mimas-music/image/upload/v1602040875/Lushfulness/Blog%20Images/footsteps-in-desert-770.jpg',
              width: 770,
              height: 510,
              alt: 'footsteps-in-desert-sand',
            },
            {
              url: 'https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/woman-in-coat-in-desert-770.jpg',
              width: 770,
              height: 496,
              alt: 'woman-in-coat-in-desert',
            },
          ],
        }}
      />
      ...
      <div className={BlogStyles.post}>
        <h1 className={MainStyles.title1}>journey with spondyloarthritis</h1>
        <ArticleJsonLd
          url="https://lushfulness.com/blog/posts/journey-with-spondyloarthritis"
          title="The Journey with Spondyloarthritis"
          images={[
            'https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/old-man-painting-770.jpg',
            'https://res.cloudinary.com/mimas-music/image/upload/v1602040875/Lushfulness/Blog%20Images/footsteps-in-desert-770.jpg',
            'https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/woman-in-coat-in-desert-770.jpg'
          ]}
        ...
        {screenSize === 'mobile' && (
          <img src='https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/old-man-painting-400.jpg' alt='old-man-painting' title='old-man-painting' />
        )}
        ...
        {screenSize === 'mobile' && (
          <img src='https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/footsteps-in-desert-400.jpg' alt='footsteps-in-desert-sand' title='footsteps-in-desert-sand' />
        )}

        {screenSize === 'desktop' && (
          <img src='https://res.cloudinary.com/mimas-music/image/upload/v1602040875/Lushfulness/Blog%20Images/footsteps-in-desert-770.jpg' alt='footsteps-in-desert-sand' title='footsteps-in-desert-sand' />
        )}

        <p>Many years ago I was married to the father of my children and very, very, sick. I had two children under the age of 3, with a husband that traveled regularly for work and his biggest concern was not his family’s well-being. Although my true diagnosis is Ankylosing Spondylitis, at that time I was diagnosed with ulcerative colitis and then chron’s disease after the inflammation spread into my small intestines as well. I was taking 60mg of prednisone a day and losing weight I did not have to lose. At 5’9”, my lowest moment was when the scale said 98 pounds. I cried and cried, sure that I was dying and my children would soon be motherless. I was on so many medications, I had medications to control the side effects of the medications controlling the side effects of the original medication. Around this time while buying a new car, the saleswoman asked if I was okay. That’s how sick I looked, strangers asked if I was okay. I shared some of my story and the day we picked up the car she gave me a book on celiac disease. I stopped eating gluten, and very slowly things began to improve. The pain continued but the fatigue improved slightly and I began to be able to digest and absorb food again. I gained weight and my brain began to function at its normal capacity.</p>

        <p>I have celiac disease and ankylosing spondylitis (axSpA or AS) without the genetic marker. My ankylosing spondylitis started off as non-radiographic axial spondyloarthritis (nr-axSpA). Thirty years with spondyloarthritis have created the undeniable evidence on x-ray to support the final diagnosis of ankylosing spondylitis. However, in the beginning, healthcare professionals were stumped by what was causing the fatigue and pain; it takes years for the disease to progress to a point that its destruction is able to be visualized on imaging. This led to a place many of us with atypical chronic illness find ourselves, tagged with the label of depressed since healthcare could not find the cause of my symptoms. The new diagnosis of non-radiographic axial spondyloarthritis (nr-axSpA) is a great advancement in the care of and treatment for patients with spondyloarthritis.</p>

        {screenSize === 'mobile' && (
          <img src='https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/woman-in-coat-in-desert-400.jpg' alt='woman-in-coat-in-desert' title='woman-in-coat-in-desert' />
        )}

        {screenSize === 'desktop' && (
          <img src='https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/woman-in-coat-in-desert-770.jpg' alt='woman-in-coat-in-desert' title='woman-in-coat-in-desert' />
        )}
        ...
        {screenSize === 'mobile' && (
          <img src='https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/leah-marcel-working-400.jpg' alt='ella-marcel-working' title='ella-marcel-working' />
        )}

        {screenSize === 'desktop' && (
          <img src='https://res.cloudinary.com/mimas-music/image/upload/v1602040876/Lushfulness/Blog%20Images/leah-marcel-working-770.jpg' alt='ella-marcel-working' title='ella-marcel-working' />
        )}

        <p>Which brings us to here now in the present moment. Where I make a written public plea to the universe. “I want to work for myself with balanced big energy for both work and home, earning more than I earn in my current corporate career, writing in my own voice, to serve the greater good of those facing spondyloarthritis. I want to empower others to live their best life from a profound state of well-being, no matter the body they are living in. I want to create an international online community of like-minded individuals that support each other in this pursuit.”</p>
